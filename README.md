...
[![GoDoc](https://godoc.org/github.com/praticode/utils?status.svg)](https://pkg.go.dev/github.com/praticode/utils)
[![Go Report Card](https://goreportcard.com/badge/github.com/praticode/utils)](https://goreportcard.com/report/github.com/praticode/utils)
...
```go
go get github.com/praticode/utils // will install latest version of v2.x.x
```
...
```go
import "github.com/praticode/utils/strutil"
```
...
import (
    "fmt"
    "github.com/praticode/utils/strutil"
)
...
```go
import "github.com/praticode/utils/algorithm"
```
...
```go
import "github.com/praticode/utils/concurrency"
```
...
```go
import "github.com/praticode/utils/condition"
```
...
```go
import "github.com/praticode/utils/convertor"
```
...
```go
import "github.com/praticode/utils/cryptor"
```
...
```go
import "github.com/praticode/utils/datetime"
```
...
```go
import list "github.com/praticode/utils/datastructure/list"
import link "github.com/praticode/utils/datastructure/link"
import stack "github.com/praticode/utils/datastructure/stack"
import queue "github.com/praticode/utils/datastructure/queue"
import set "github.com/praticode/utils/datastructure/set"
import tree "github.com/praticode/utils/datastructure/tree"
import heap "github.com/praticode/utils/datastructure/heap"
import hashmap "github.com/praticode/utils/datastructure/hashmap"
```
...
```go
import "github.com/praticode/utils/fileutil"
```
...
```go
import "github.com/praticode/utils/formatter"
```
...
```go
import "github.com/praticode/utils/function"
```
...
```go
import "github.com/praticode/utils/maputil"
```
...
```go
import "github.com/praticode/utils/mathutil"
```
...
```go
import "github.com/praticode/utils/netutil"
```
...
```go
import "github.com/praticode/utils/random"
```
...
```go
import "github.com/praticode/utils/retry"
```
...
```go
import "github.com/praticode/utils/slice"
```
...
```go
import "github.com/praticode/utils/system"
```
...
```go
import "github.com/praticode/utils/validator"
```
...
```go
import "github.com/praticode/utils/xerror"
```
